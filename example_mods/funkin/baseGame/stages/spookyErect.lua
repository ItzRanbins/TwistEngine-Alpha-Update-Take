function onCreate()
	makeAnimatedLuaSprite('outdoorTrees', 'stages/erectStages/week2/bgtrees', 190, 30)
	addAnimationByPrefix('outdoorTrees', 'anim', 'bgtrees', 5)
	setScrollFactor('outdoorTrees', 0.85, 0.85)
	addLuaSprite('outdoorTrees')

	makeLuaSprite('corridorDark', 'stages/erectStages/week2/bgDark', -360, -220)
	addLuaSprite('corridorDark')

	if lowQuality == false then
		makeLuaSprite('corridor', 'stages/erectStages/week2/bgLight', -360, -220)
		addLuaSprite('corridor')
		setProperty('corridor.alpha', 0)

		makeLuaSprite('stairsDark', 'stages/erectStages/week2/stairsDark', 966, -225)
		addLuaSprite('stairsDark', true)

		makeLuaSprite('stairs', 'stages/erectStages/week2/stairsLight', 966, -225)
