function onCreate()
	...
	makeLuaSprite('bar', 'stages/erectStages/week7/bg', -985, -805)
	scaleObject('bar', 1.15, 1.15)
	addLuaSprite('bar')

	if lowQuality == false then
		makeAnimatedLuaSprite('sniper', 'stages/erectStages/week7/sniper', -127, 349)
		...
		makeAnimatedLuaSprite('tankguy', 'stages/erectStages/week7/guy', 1398, 407)
