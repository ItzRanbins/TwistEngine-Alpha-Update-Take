function onCreate()
    makeLuaSprite('sky', 'weeb/weebSky', -626, -78)
	scaleObject('sky', 6, 6)
	...
	if lowQuality == false then
		makeLuaSprite('treesBG', 'weeb/weebBackTrees', -842, -80)
	...
	if lowQuality == false then
		makeAnimatedLuaSprite('leaves', 'weeb/petals', -20, -40)
		...
		makeAnimatedLuaSprite('girlfreaks', 'weeb/bgFreaks', -646, 222)
