function onCreate()
	if lowQuality == false then
		makeLuaSprite('sky', 'stages/erectStages/week3/sky', -100, 0)
		setScrollFactor('sky', 0.1, 0.1)
		addLuaSprite('sky')
	end

	makeLuaSprite('city', 'stages/erectStages/week3/city', -10, 0)
	scaleObject('city', 0.85, 0.85)
	setScrollFactor('city', 0.3, 0.3)
	addLuaSprite('city')

	makeLuaSprite('window', 'stages/week3/win', 50, 100)
	...
	if lowQuality == false then
		makeLuaSprite('behindTrain', 'stages/erectStages/week3/behindTrain', -40, 50)
	...
	makeLuaSprite('street', 'stages/erectStages/week3/street', -40, 50)
	addLuaSprite('street')
end
...
function onCreatePost()
	...
	for note = 0, getProperty('eventNotes.length') - 1 do
        if getPropertyFromGroup('eventNotes', note, 'event') == 'Philly Glow' then
			...
			makeLuaSprite('windowEvent', 'stages/week3/win', 50, 100)
