function onCreate()
	makeLuaSprite('sunset', 'stages/erectStages/week4/limoSunset', -220, -80)
	scaleObject('sunset', 0.9, 0.9)
	setScrollFactor('sunset', 0.1, 0.1)
	addLuaSprite('sunset')

	makeAnimatedLuaSprite('shootingStar', 'stages/erectStages/week4/shooting star', 200, 0)
	...
	if lowQuality == false then
		makeAnimatedLuaSprite('limoBG', 'stages/erectStages/week4/bgLimo', -200, 480)
		addAnimationByPrefix('limoBG', 'anim', 'background limo blue')
		setScrollFactor('limoBG', 0.4, 0.4)
		addLuaSprite('limoBG')

		for i = 1, 5 do
			makeAnimatedLuaSprite('henchmen'..i, 'stages/week4/limoDancer', getProperty('limoBG.x') + 300 * i, 100)
	...
	makeLuaSprite('car', 'stages/week4/fastCarLol', -12600, 160)
	addLuaSprite('car')
	precacheSound('carPass0')
	precacheSound('carPass1')

	makeAnimatedLuaSprite('limo', 'stages/erectStages/week4/limoDrive', -120, 520)
...
function onCreatePost()
	if lowQuality == false then
        ...
        for mistNum, data in ipairs(mistData) do
            for i = 0, 2 do
                makeLuaSprite('mist'..mistNum..''..(i + 1), 'stages/erectStages/week4/'..data.mistImage, -650, -100)
...
function carDrive()
	...
	playSound('stages/week4/carPass'..soundNum, 0.7)
