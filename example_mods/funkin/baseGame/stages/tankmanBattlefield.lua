...
function onCreate()
    ...
    makeAnimatedLuaSprite('tankRolling', 'tank/tankRolling', 300, 300)
    ...
    makeLuaSprite('ground', 'tank/tankGround', -420, -150)
    scaleObject('ground', 1.15, 1.15)
    addLuaSprite('ground')

    makeLuaSprite('bricks', 'tank/bricksGround', 438, 715)
    scaleObject('bricks', 1.15, 1.15)
    setObjectOrder('bricks', getObjectOrder('gfGroup') + 1)
    addLuaSprite('bricks')

    makeAnimatedLuaSprite('tankAudience0', 'tank/tank0', -500, 650)
    ...
    makeAnimatedLuaSprite('tankAudience2', 'tank/tank2', 360, 980)
    ...
    makeAnimatedLuaSprite('tankAudience5', 'tank/tank5', 1550, 700)
    ...
    if lowQuality == false then
        makeAnimatedLuaSprite('tankAudience4', 'tank/tank4', 1200, 900)
        ...
        makeAnimatedLuaSprite('tankAudience3', 'tank/tank3', 1050, 1240)
        ...
        makeAnimatedLuaSprite('tankAudience1', 'tank/tank1', -300, 750)
